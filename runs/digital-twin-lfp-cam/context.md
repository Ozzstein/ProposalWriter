...
*Note: Quantitative carbon abatement numbers (tCO₂eq/year) require BatteryCo's production capacity and energy consumption data — to be obtained.*

## Team
- **Lead applicant**: BatteryCo (joint venture of BatteryCo S.p.A. and EnergyCo)
  - BatteryCo S.p.A.: Italian industrial battery manufacturer
  - EnergyCo: Italian energy major (strategic partner for energy transition)
...
- **Location**: the plant site, Italy — EnergyCo brownfield site — eligible EU Member State ✓
- **Applicants**: BatteryCo (BatteryCo S.p.A. & EnergyCo) — single beneficiary, no consortium required ✓
...
1. What synthesis route does BatteryCo plan to use? (solid-state most likely for industrial scale)
2. Reference energy consumption for GHG calculator (conventional gas-fired baseline)
3. Expected grid carbon intensity for the plant site (Puglia region) — needed for GHG calculation
...
6. Any permits already in progress for the the plant site site?
