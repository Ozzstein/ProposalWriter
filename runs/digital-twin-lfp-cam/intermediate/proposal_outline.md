...
- Project objectives: develop, deploy and validate ISO 23247 four-layer DT at BatteryCo the plant site plant
...
- BatteryCo (joint venture of BatteryCo S.p.A. + EnergyCo): lead applicant
  - BatteryCo S.p.A.: Italian battery manufacturer (founding year, employees, expertise)
  - EnergyCo: Italian energy major (founding year, employees, relevant expertise in industrial process digitalization)
- Why BatteryCo is best placed: industrial-scale LFP manufacturing planned; EnergyCo brownfield site; BatteryCo battery expertise
- TBD research partners (Italian universities / EU RTOs)

### 0.3 Technical Characteristics and Scope
- Location: the plant site, Italy — EnergyCo brownfield industrial site
...
- Reference scenario: conventional gas-fired rotary kiln calcination + grid electricity for milling/utilities
  - Gas consumption: [TBD — need BatteryCo energy data; typical ~6-10 MWh thermal/t LFP for calcination]
...
#### Financing Plan
- CAPEX €250M: equity (EnergyCo/BatteryCo S.p.A.) + senior debt + IF grant (max €150M = 60%)
...
- EnergyCo: equity commitment (evidence: letter of support / board resolution)
- BatteryCo S.p.A.: equity commitment
...
- the plant site brownfield site: existing EnergyCo industrial zoning (advantage over greenfield)
- Environmental Impact Assessment: [status TBD — confirm whether in progress]
- Building permits: Comune di the plant site application timeline
- Operating permit (AIA — Autorizzazione Integrata Ambientale): Italian VIA process
- Public acceptance: the plant site industrial zone (established industrial context)
- IP: DT software models owned by BatteryCo; open-source components (OpenFOAM) identified

#### Project Management Team
- Project Director: [TBD — EnergyCo/BatteryCo nominee]
- DT Technical Lead: [TBD — partner university nominee]
- Process Engineering Lead: BatteryCo S.p.A.
- EPC Contractor: [strategy: open tender via EU procurement]
- O&M DT: in-house capability built during commissioning

#### Project Diagram
[Insert stakeholder diagram: EC/CINEA → BatteryCo → EnergyCo (equity) + BatteryCo S.p.A. (equity) + Lenders (debt) + EPC Contractor + Technology Partners + Raw Material Suppliers + Offtake Customers]
...
- Permitting risk: Italian AIA timeline — **mitigation**: the plant site brownfield reduces risk; early permit pre-consultation
- Energy price risk: electricity cost — **mitigation**: long-term renewable PPA with EnergyCo
...
- **Climate change adaptation**: the plant site industrial zone — existing flood/climate risk assessment
- **Water and marine resources**: closed-loop water treatment; no marine discharge; the plant site coastal proximity → marine impact assessment
...
- European industrial ecosystems: Italian battery cluster (BatteryCo, BatteryCo, other Italian cell makers)
...
- Bonus 2 (SME): Not applicable — BatteryCo is not an SME (BatteryCo + EnergyCo are large companies)
...
|---|---|---|---|---|
| WP1 | Project Management and Coordination | BatteryCo | Months 1–48 | TBD |
| WP2 | DT System Architecture and Model Development | BatteryCo + University partner | Months 1–24 | TBD |
| WP3 | PAT Sensor Integration and Validation | BatteryCo | Months 6–30 | TBD |
| WP4 | MPC and Bayesian Optimisation Implementation | BatteryCo | Months 12–36 | TBD |
| WP5 | Plant Construction and Equipment Installation | BatteryCo (EPC) | Months 12–42 | TBD |
| WP6 | DT Commissioning and System Integration | BatteryCo | Months 36–48 | TBD |
| WP7 | Monitoring, Reporting and Knowledge Sharing | BatteryCo | Months 42–120 (operation) | TBD |
...
| Permits and licences | Current status documentation | No page limit | **To be obtained from BatteryCo** |
...
1. **GHG data**: BatteryCo's reference energy consumption for calcination (MWh/t LFP) — needed for GHG calculator
2. **Grid carbon intensity**: Puglia region (ENTSO-E or Terna data for 2026 baseline)
3. **Synthesis route confirmation**: solid-state route assumed — confirm with BatteryCo
4. **Relevant costs breakdown**: electric kiln premium vs gas baseline; DT system cost estimate
5. **Permits status**: EIA progress for the plant site site — confirm with BatteryCo
