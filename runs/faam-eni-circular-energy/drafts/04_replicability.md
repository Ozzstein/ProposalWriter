...
- **Zero on-site combustion emissions**: No NOx, SOx, CO, or particulate matter from natural gas combustion. Conventional gas-fired rotary kilns generate approximately 0.5-2.0 kg NOx per tonne of product; the Brindisi electric kilns produce zero combustion-related air pollutants [CLM-011].
...
**Mitigation measures:**
- **Closed-loop water system**: Spray dryer condensate recovery recirculates process water, reducing freshwater demand by 70-85% [ASSUMPTION: exact recovery rate pending detailed engineering].
...
**Mitigation measures:**
- **Air emissions**: Zero on-site combustion (fully electrified). HEPA filtration on all powder handling exhausts. Calcination atmosphere is contained (sealed kiln with N2 blanket). No volatile organic compound (VOC) emissions — glucose carbon precursor is pyrolysed under inert atmosphere, not volatilised.
...
- **Italian universities**: Collaboration with Italian academic institutions for multi-scale modeling development, particularly CFD simulation of roller hearth kiln thermal profiles, population balance modeling of spray drying particle formation, and machine learning surrogate model development [ASSUMPTION: specific university partnerships to be confirmed by project coordinator].
...
- **Direct manufacturing employment**: Operators, process engineers, quality control technicians, and maintenance staff for the LFP CAM production line [ASSUMPTION: specific job numbers to be provided by FIB HR planning].
